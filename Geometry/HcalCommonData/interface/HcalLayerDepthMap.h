...
public:
  ...
  HcalLayerDepthMap();
  ~HcalLayerDepthMap();
  void initialize(int subdet, int ietaMax, int zside, int dep29C, double wtl0C,
  ...
  int    getDepth(int subdet, int ieta, int iphi, int zside, int layer) const;
  ...
  int    getDepthMax(int subdet, int ieta, int iphi, int zside) const;
  std::pair<int,int> getDepths(int eta) const;
  int    getLayerFront(int subdet, int ieta, int iphi, int zside, int depth) const;
  int    getLayerBack(int subdet, int ieta, int iphi, int zside, int depth) const;
  double getLayer0Wt(int subdet, int iphi, int zside) const;
  int    getMaxDepthLastHE(int subdet, int iphi, int zside) const;
  bool   isValid(int det, int phi, int zside) const;
  int    validDet(int& zside, std::vector<int>& phis) const;
